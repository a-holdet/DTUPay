...
public class EventService implements IEventReceiver {
	...
	private static final IMerchantService merchantService = MessageQueueAccountService.getInstance();
	private static final ICustomerService customerService = MessageQueueAccountService.getInstance();
	IEventSender sender;
